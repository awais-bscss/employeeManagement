...
const AcceptTask = ({ data }) => {
  ...
  return (
    <div className=" shrink-0  h-[260px] w-[25%] p-5 bg-red-500  rounded-2xl ml-4">
      ...
      <div className="flex justify-between mt-3">
        ...
        <button className="bg-red-800  cursor-pointer px-2 text-sm py-1 rounded >Mark as Failed">
          Mark as Failed
        </button>
      </div>
    </div>
